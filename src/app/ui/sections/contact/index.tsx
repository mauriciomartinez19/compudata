                ...
                <div className="flex flex-wrap px-3 pt-12 pb-12 md:pb-0 lg:pt-0">
                  <div className="mb-12 w-full shrink-0 grow-0 basis-auto px-3 md:w-6/12 md:px-6 lg:w-full xl:w-6/12 xl:px-12">
                    <div className="flex items-start">
                      ...
                      <div className="ml-6 grow">
                        <p className="mb-2 font-bold">Teléfono de contacto</p>
                  ...
                  <div className="mb-12 w-full shrink-0 grow-0 basis-auto px-3 md:w-6/12 md:px-6 lg:w-full xl:w-6/12 xl:px-12">
                    <div className="flex items-start">
                      ...
                      <div className="ml-6 grow">
                        <p className="mb-2 font-bold">Localización</p>
                        <p className="text-white">Gral Enrique Martínez 1311</p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="ml-6 grow">
                        ...
                        <div className="flex flex-col">
                          ...
                          <a
                            className="text-white no-underline"
                            target="_blank"
                            href="mailto:jamar2006@gmail.com"
                          >
                            jamar2006@gmail.com
                          </a>
                        </div>
